...
export default function About() {
  ...
  return (
    <section className="dbm-section" id="about">
      <div className="dbm-container grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <motion.div
        ...
        >
          ...
          <div className="absolute -bottom-6 -right-6 md:right-6 bg-[hsl(var(--accent))] text-white px-6 py-5 hidden md:block">
            <div className="font-display text-4xl font-semibold leading-none">2023</div>
          ...
          <div className="absolute top-6 left-6 bg-[hsl(var(--primary))]/95 text-white px-5 py-3 backdrop-blur-sm">
            ...
            <div className="font-mono text-sm font-semibold mt-0.5">{COMPANY.nib}</div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.7 }}
        >
          <div className="dbm-overline mb-4">{t('about.overline')}</div>
          <h2 className="dbm-h2 mb-6">{t('about.title')}</h2>
          ...
          <a href="#contact" className="dbm-btn dbm-btn-primary" data-testid="about-cta">
