...
export default function CTA() {
  ...
  return (
    <section className="bg-[hsl(var(--primary))] text-white relative overflow-hidden">
      ...
      />
      <div className="dbm-container py-20 md:py-28 relative text-center">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        >
          <div className="dbm-overline mb-6">▲ {t('cta.eyebrow')}</div>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <a
              ...
              className="dbm-btn bg-white text-[hsl(var(--primary))] hover:bg-gray-100"
