...
export default function FAQ() {
  ...
  return (
    <section className="dbm-section" id="faq">
      <div className="dbm-container grid lg:grid-cols-12 gap-12">
        <div className="lg:col-span-4">
          <div className="dbm-overline mb-4">{t('faq.overline')}</div>
          <h2 className="dbm-h2">{t('faq.title')}</h2>
        </div>
