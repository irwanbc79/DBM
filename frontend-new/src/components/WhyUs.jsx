...
export default function WhyUs() {
  ...
  return (
    <section className="dbm-section bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] relative overflow-hidden">
      ...
      <div className="dbm-container relative">
        <div className="mb-14 max-w-3xl">
          <div className="dbm-overline mb-4">{t('why.overline')}</div>
          <h2 className="dbm-h2">{t('why.title')}</h2>
        </div>
