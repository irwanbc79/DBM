...
export default function Services() {
  ...
  return (
    <section className="dbm-section bg-[hsl(var(--surface))] relative" id="services">
      <div className="absolute inset-0 noise-overlay" />
      <div className="dbm-container relative">
        <div className="grid lg:grid-cols-12 gap-8 mb-14">
          <div className="lg:col-span-6">
            <div className="dbm-overline mb-4">{t('services.overline')}</div>
            <h2 className="dbm-h2">{t('services.title')}</h2>
          </div>
